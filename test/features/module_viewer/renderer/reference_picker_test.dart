...
import 'package:aj_assistant/features/module_viewer/renderer/blueprint_node.dart';
import 'package:aj_assistant/features/module_viewer/renderer/blueprint_parser.dart';
import 'package:aj_assistant/features/module_viewer/renderer/render_context.dart';
import 'package:aj_assistant/features/module_viewer/renderer/widget_registry.dart';
    ...
    Widget buildWidget({
      ...
      final viewerBloc = bloc ??
          (ModuleViewerBloc(
            ...
            userId: 'user1',
          )..emit(ModuleViewerLoaded(module: module, entries: entries)));
