...
const _blueprintReference = 'BLUEPRINT REFERENCE:\n'
    ...
    //
    '=== TABLES & QUERIES (CRITICAL) ===\n\n'
    'TABLES:\n'
    '  Provide structured column definitions in "tables". CREATE TABLE, DROP TABLE, '
    'and all mutations (INSERT/UPDATE/DELETE) are auto-generated.\n'
    '  "tables": {\n'
    '    "schemaKey": {\n'
    '      "columns": [\n'
    '        { "name": "col_name", "type": "text|number|boolean|datetime|enumType|multiEnum|currency|rating|reference|duration|url|phone|email", "required": true }\n'
    '      ]\n'
    '    }\n'
    '  }\n'
    '  Rules:\n'
    '  - Do NOT write raw SQL for table creation — it is auto-generated.\n'
    '  - id, created_at, updated_at are added automatically.\n'
    '  - Column types map to SQL: text/url/phone/email/enumType/reference/multiEnum → TEXT, '
    'number/currency/duration/rating → REAL, datetime/boolean → INTEGER.\n\n'
    'QUERIES:\n'
    '  "queries": {\n'
    '    "queryName": { "sql": "SELECT id, col1, col2 FROM {{schemaKey}} ORDER BY created_at DESC" }\n'
    '  }\n'
    '  Rules:\n'
    '  - Use {{schemaKey}} placeholders for table names — they are auto-resolved to actual table names.\n'
    '  - SELECT MUST include the "id" column.\n'
    '  - The query name is used by "source" on entry_list, stat_card, chart widgets.\n'
    '  - For aggregate stats: "total": { "sql": "SELECT SUM(amount) as total FROM {{default}}" }\n'
    '  - For parameterized queries (detail screens): add "params": { "id": "{{_entryId}}" }\n\n'
    'MUTATIONS:\n'
    '  Do NOT write mutations — they are auto-generated from form_screen "table" property.\n'
    '  - form_screen with submitLabel → insert mutation generated\n'
    '  - form_screen with editLabel → update mutation generated\n'
    '  - Any screen tree containing delete_entry → delete mutation generated\n\n'
    //
    // ── Screen types ──
    //
    '=== SCREEN TYPES ===\n\n'
    'screen — displays data:\n'
    '  { type: "screen", title?, queries: {...}, children: [...], '
    'fab?, appBar?, appBarActions?: [...] }\n\n'
    'form_screen — creates/edits entries:\n'
    '  { type: "form_screen", title?, table: "schemaKey", queries?: {...}, '
    'children: [...], submitLabel?, editLabel?, defaults? }\n'
    '  - table: schema key targeting which table to write to. Mutations are auto-generated.\n'
    ...
    '  - queries: aggregate stats + recent entries using {{schemaKey}} placeholders\n'
    ...
    '  - queries: all entries using {{schemaKey}} placeholders\n'
    '  - children: entry_list with source, itemLayout, swipeActions, emptyState\n'
    '  - fab navigates to add form\n\n'
    'ADD FORM:\n'
    '  - type: form_screen, table: "schemaKey", submitLabel: "Save"\n'
    '  - mutations auto-generated from table property\n'
    ...
    'EDIT FORM:\n'
    '  - type: form_screen, table: "schemaKey", editLabel: "Update"\n'
    '  - mutations auto-generated from table property\n'
    ...
    '      "queries": {\n'
    '        "total_done": { "sql": "SELECT COUNT(*) as total FROM {{default}} WHERE completed = 1" },\n'
    '        "today_count": { "sql": "SELECT COUNT(*) as total FROM {{default}} WHERE completed = 1 AND date >= strftime(\'%s\', date(\'now\')) * 1000" },\n'
    '        "recent": { "sql": "SELECT id, name, date, completed, note FROM {{default}} ORDER BY date DESC, created_at DESC" }\n'
    '      },\n'
    '      "children": [\n'
